...
const Section1 = () => {
    return(
        ...
        text-[white] px-[clamp(40px,11vw,165px)] max-md:px-10 pt-[73px] max-md:pt-16 pb-[250px] min-[375px]:pb-[clamp(200px,50vw,250px)]">
            ...
            <div className="flex max-md:flex-col max-md:text-center gap-x-[32px]">
                ...
                <div className="flex flex-col justify-between items-center">
                    ...
                    <p className={`${typography.body_1} w-[445px] max-md:w-[457px] min-[375px]:w-[clamp(327px,80vw,457px)]`}>
