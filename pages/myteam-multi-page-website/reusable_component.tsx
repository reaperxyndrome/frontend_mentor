...
const Button : React.FC<ButtonProp> = ({className, title}) => {
    return(
        <div className={twMerge(`flex items-center justify-center text-[white] rounded-full w-[153px] h-[48px] px-[30px] py-[10px] border-2 cursor-pointer`, className)}>
            <p>{title}</p>
        </div>
    )
}
...
const ContactButton2 = () => {
    return(
        <Button className={` text-myteam_multi_page_website-secondary-sacramento_state_green hover:bg-myteam_multi_page_website-secondary-sacramento_state_green hover:border-myteam_multi_page_website-secondary-sacramento_state_green
        hover:text-[white]`}
          title="contact us"/>
    )
}
...
const IconFacebook = () => {
    const FACEBOOK_PATHDATA = "M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.407.593 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.323-.593 1.323-1.325V1.325C24 .593 23.407 0 22.675 0z"
...
const IconLinkedIn = () => {
    const LINKEDIN_PATHDATA = "M18 0H2C.9 0 0 .9 0 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V2c0-1.1-.9-2-2-2zM6 17H3V8h3v9zM4.5 6.3c-1 0-1.8-.8-1.8-1.8s.8-1.8 1.8-1.8 1.8.8 1.8 1.8-.8 1.8-1.8 1.8zM17 17h-3v-5.3c0-.8-.7-1.5-1.5-1.5s-1.5.7-1.5 1.5V17H8V8h3v1.2c.5-.8 1.6-1.4 2.5-1.4 1.9 0 3.5 1.6 3.5 3.5V17z"
    ...
    return(
        <nav className={twMerge(`${typography.body_1} text-[white] flex gap-x-3 justify-between`, className)}>
            <div className="flex items-center ">
                ...
                <Link className="mr-10 hover:text-myteam_multi_page_website-primary-light_coral" href={""}>home</Link>
                <Link className="hover:text-myteam_multi_page_website-primary-light_coral" href={""}>about</Link>
            </div>
...
const ContactSection = () => {
    return(
        <section className="relative flex justify-between py-[76px] px-[260px] bg-myteam_multi_page_website-primary-light_coral">
